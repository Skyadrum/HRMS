...
PersonaInicio, PersonaFormato, PersonaListInactive, PersonaInactivePdf
...
urlpatterns = [
    ...
    url(r'^listado_persona$', PersonaList.as_view(), name='listado_persona'), #activos
    url(r'^baja_persona$', PersonaListInactive.as_view(), name='baja_persona'), #inactivos
    url(r'^baja_list$', PersonaInactivePdf, name='baja_list'), #inactivosPDF
